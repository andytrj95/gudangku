        ...
        <div class="card h-md-100">
            ...
            <div class="card-body d-flex flex-column flex-left">
                ...
                <div class="mb-2">
                    ...
                    <form action="{{ url('/dashboard/barang/'.$barang->kode_barang) }}" method="POST">
                        @csrf @method('patch')
                        <!--begin::Input group-->
                        <div class="d-flex flex-column flex-md-row gap-5">
                            <div class="card card-flush py-4 flex-row-fluid">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="kode_barang" placeholder="Kode Barang" value="{{ old('kode_barang', $barang->kode_barang) }}" />
                                    @error('kode_barang')                    
                                ...
                                <input class="form-control" name="nama_barang" placeholder="Nama Barang" value="{{ old('nama_barang', $barang->nama_barang) }}" />
                                @error('nama_barang')                    
                                <span class="text-danger">
                                    {{ $message }}
                                </span>    
                                ...
                                <select class="form-select" data-placeholder="Select Kategori"  name="name">
                                    ...
                                    @if (old('name' ,$barang->supplier_id) == $spl->id)
                                ...
                                <select class="form-select" data-placeholder="Select Satuan barang"  name="nama_satuan">
                                    ...
                                    @if (old('nama_satuan' ,$barang->satuan_id) == $satuanbarang->id)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" data-placeholder="Select Kategori"  name="nama_kategori">
                                        ...
                                        @if (old('nama_kategori', $barang->kategori_id) == $kategoribarang->id)
                            ...
                            <div class="card card-flush py-4 flex-row-fluid">
                                ...
                                <input class="form-control" type="number" name="qty" placeholder="Qty Barang" value="{{ old('qty', $barang->qty) }}" />
                                @error('qty')                    
                                <span class="text-danger">
                                    {{ $message }}
                                </span>    
                                ...
                                <input class="form-control" type="number" name="harga_beli" placeholder="Harga Beli Barang" value="{{ old('harga_beli' , $barang->harga_beli) }}" />
                                @error('harga_beli')                    
                                <span class="text-danger">
                                    {{ $message }}
                                </span>    
                                ...
                                <input class="form-control" type="number" name="harga_jual" placeholder="Harga Jual Barang" value="{{ old('harga_jual' ,$barang->harga_jual) }}" />
                                @error('harga_jual')                    
                                <span class="text-danger">
                                    {{ $message }}
                                </span>    
                                ...
                                <input class="form-control" type="date" name="tanggal" value="{{ old('tanggal', now()) }}"/>
                                @error('tanggal')                    
                                <span class="text-danger">
                                    {{ $message }}
                                </span>    
